...
export const centeredOnboardingDialogClass =
	"fixed left-1/2 top-1/2 z-overlay w-dialog-xl max-w-none -translate-x-1/2 -translate-y-1/2 gap-0 overflow-hidden rounded-lg border border-border bg-popover p-0 text-popover-foreground shadow-xl data-[state=open]:animate-modal-in data-[state=closed]:animate-modal-out motion-reduce:animate-none";
...
export const onboardingPanelBodyClass = "flex flex-col gap-5 px-4 pb-4";
...
export const onboardingFooterActionsClass = "flex items-center justify-between gap-3";
export const onboardingFooterActionsEndClass = "flex items-center justify-end gap-3";
